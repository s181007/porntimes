...
%JAVA_EXE% -Duser.language=ja %MAXMEMORY% -Djava.security.manager -Djava.security.policy=app\res\live2d.policy -Djogamp.gluegen.UseTempJarCache=false -Djava.library.path="app/dll64;app/dll64/windows-amd64" -classpath "%EXECUTABLE_JAR%;%COMMONS%" com.live2d.cubism.CECubismEditorApp "%~f1"
